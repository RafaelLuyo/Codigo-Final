...
# ============================================
# Script de Backup para Jenkins Deployment
# Sube backups a AWS S3: bucket-codigo-backup-rafael
# Subcarpeta: luyo-rafael/database-jenkins/YYYYMMDDHHMMSS/
# ============================================
...
# Configuración de AWS S3 para Jenkins
AWS_BUCKET="bucket-codigo-backup-rafael"
SUBFOLDER="luyo-rafael/database-jenkins"
...
echo "=========================================="
echo "Iniciando backup de base de datos (Jenkins)"
...
echo "=========================================="
echo "Backup completado exitosamente (Jenkins)!"
